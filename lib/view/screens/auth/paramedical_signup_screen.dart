...
class ParamedicalSignUpScreen extends StatefulWidget {
  ParamedicalSignUpScreen({Key? key}) : super(key: key);

  @override
  State<ParamedicalSignUpScreen> createState() => _ParamedicalSignUpScreenState();
}

class _ParamedicalSignUpScreenState extends State<ParamedicalSignUpScreen> {
